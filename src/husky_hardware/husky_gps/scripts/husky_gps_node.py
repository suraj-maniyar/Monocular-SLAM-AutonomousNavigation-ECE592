...
from husky_gps.msg import gps_info
from husky_gps.msg import gps_velocity
import serial
...
def gps_data_handler():
  ...
  pub1 = rospy.Publisher('/husky_gps/general_info', gps_info, queue_size=10)
  pub2 = rospy.Publisher('/husky_gps/velocity_info', gps_velocity, queue_size=10)

  rospy.init_node('husky_gps', anonymous=True)
  date_flag=0
...
if __name__ == '__main__':
  ...
  port = "/dev/ttyUSB0"
  GPS_serial = serial.Serial(port, baudrate = 115200, timeout = 0.5)
  gps_data_handler()
  rospy.spin()