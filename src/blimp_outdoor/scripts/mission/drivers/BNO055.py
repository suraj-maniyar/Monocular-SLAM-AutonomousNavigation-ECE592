...
import time
import struct
#import tf.transformations.euler_from_quaternion
...
class BNO055:
	...
	def begin(self, mode=None):
		...
		# Set the calibration
		cal_data = [249, 255, 241, 255, 26, 0, 191, 254, 99, 0, 152, 0, 255, 255, 253, 255, 0, 0, 232, 3, 248, 2]
...
if __name__ == '__main__':
	...
	while True:
		...
		# print euler_from_quaternion(bno.getQuat())
